...
```{r, echo = F}
knitr::kable(tibble::tibble(method = c("One word embedding (spacy)", "All word embeddings (spacy)", "Basic NN (spacy)", "One word eembedding (BERT)", "All word embeddings (BERT)", "Basic NN (BERT)",  "LSTM"),
       MSE = c(.149, .289, .064, .141, .201, .152, .130)))
```
