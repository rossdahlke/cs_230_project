...
train_encoding = tokenizer(train_batch, return_tensors='pt', padding=True, truncation=True, max_length = 100)
...
test_encoding = tokenizer(test_batch, return_tensors='pt', padding=True, truncation=True, max_length = 100)
...
eval_encoding = tokenizer(eval_batch, return_tensors='pt', padding=True, truncation=True, max_length = 100)
